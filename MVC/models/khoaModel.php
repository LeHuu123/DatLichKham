...
class khoaModel extends connectDB
{
        ...
        function danhSachKhoa()
        {
                ...
                curl_setopt($ch, CURLOPT_URL, "http://localhost/MVC_Api_DatLichKham/khoa/getdata");
        ...
        function themKhoa($post)
        {

                $url = "http://localhost/MVC_Api_DatLichKham/khoa/insertKhoa";
                // Khởi tạo cURL
                $ch = curl_init($url);
        ...
        function suaKhoa($post)
        {
                $data = json_encode($post);
                $url = "http://localhost/MVC_Api_DatLichKham/khoa/updateKhoa?maKhoa=" . $post['maKhoa'];
                // Khởi tạo cURL
        ...
        function xoaKhoa($maKhoa)
        {
                $url = "http://localhost/MVC_Api_DatLichKham/khoa/deleteKhoa?maKhoa=" . $maKhoa;
